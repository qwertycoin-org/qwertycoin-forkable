...
NewBlockMessage::NewBlockMessage(const Crypto::FHash &hash)
    : blockHash(hash)
{
}

void NewBlockMessage::get(Crypto::FHash &hash) const
{
    hash = blockHash;
}

NewAlternativeBlockMessage::NewAlternativeBlockMessage(const Crypto::FHash &hash)
    : blockHash(hash)
{
}

void NewAlternativeBlockMessage::get(Crypto::FHash &hash) const
{
    hash = blockHash;
}

ChainSwitchMessage::ChainSwitchMessage(std::vector<Crypto::FHash> &&hashes)
...
void ChainSwitchMessage::get(std::vector<Crypto::FHash> &hashes) const
{
...
bool BlockchainMessage::getNewBlockHash(Crypto::FHash &hash) const
{
...
bool BlockchainMessage::getNewAlternativeBlockHash(Crypto::FHash &hash) const
{
...
bool BlockchainMessage::getChainSwitch(std::vector<Crypto::FHash> &hashes) const
{
