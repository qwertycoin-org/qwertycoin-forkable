...
public:
    ...
    bool check_block(uint32_t height, const Crypto::FHash &h) const;
    bool check_block(uint32_t height, const Crypto::FHash &h, bool &is_a_checkpoint) const;
...
private:
    std::map<uint32_t, Crypto::FHash> m_points;
