...
public:
    ...
    size_t difficultyBlocksCount2() const { return QwertyNote::parameters::DIFFICULTY_WINDOW_V2; }
    ...
    bool getBlockReward(
        ...
        uint32_t height,
        uint64_t blockTarget = QwertyNote::parameters::DIFFICULTY_TARGET) const;
