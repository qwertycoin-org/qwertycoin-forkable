...
Crypto::FPublicKey getTransactionPublicKeyFromExtra(const std::vector<uint8_t> &tx_extra);
bool addTransactionPublicKeyToExtra(std::vector<uint8_t> &tx_extra, const Crypto::FPublicKey &tx_pub_key);
bool addExtraNonceToTransactionExtra(std::vector<uint8_t> &tx_extra, const BinaryArray &extra_nonce);
void setPaymentIdToTransactionExtraNonce(BinaryArray &extra_nonce, const Crypto::FHash &payment_id);
bool getPaymentIdFromTransactionExtraNonce(const BinaryArray &extra_nonce,Crypto::FHash &payment_id);
...
bool getPaymentIdFromTxExtra(const std::vector<uint8_t> &extra, Crypto::FHash &paymentId);
bool parsePaymentId(const std::string &paymentIdString, Crypto::FHash &paymentId);
