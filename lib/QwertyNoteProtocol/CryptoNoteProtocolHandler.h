...
class CryptoNoteProtocolHandler : public i_cryptonote_protocol, public IQwertyNoteProtocolQuery
{
public:
    ...
    bool addObserver(IQwertyNoteProtocolObserver *observer) override;
    bool removeObserver(IQwertyNoteProtocolObserver *observer) override;
