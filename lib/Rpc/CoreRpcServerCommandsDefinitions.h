...
struct COMMAND_RPC_GET_HEIGHT {
    struct response {
        void serialize(ISerializer &s) { KV_MEMBER(height) KV_MEMBER(status) }
...
struct COMMAND_RPC_GET_BLOCKS_FAST {
    ...
    struct response {
        void serialize(ISerializer &s) { KV_MEMBER(blocks) KV_MEMBER(start_height)
                                                 KV_MEMBER(current_height) KV_MEMBER(status) }
...
struct COMMAND_RPC_GET_TRANSACTIONS {
    ...
    struct response {
        void serialize(ISerializer &s) { KV_MEMBER(txs_as_hex) KV_MEMBER(missed_tx)
                                                 KV_MEMBER(status) }
...
struct TxWithOutputGlobalIndices {
    void serialize(ISerializer &s) { KV_MEMBER(transaction) KV_MEMBER(hash) KV_MEMBER(block_hash)
                                             KV_MEMBER(height) KV_MEMBER(fee) KV_MEMBER(timestamp)
...
struct COMMAND_RPC_GET_TRANSACTIONS_BY_HEIGHTS {
    struct request {
        void serialize(ISerializer &s) { KV_MEMBER(heights) KV_MEMBER(as_json)
                                                 KV_MEMBER(include_miner_txs) KV_MEMBER(range) }
    ...
    struct entry {
        void serialize(ISerializer &s) { KV_MEMBER(tx_hash) KV_MEMBER(as_json) KV_MEMBER(fee)
                                                 KV_MEMBER(block_height) KV_MEMBER(block_timestamp)
    ...
    struct response {
        void serialize(ISerializer &s) { KV_MEMBER(missed_tx) KV_MEMBER(txs) KV_MEMBER(status) }
...
struct COMMAND_RPC_GET_RAW_TRANSACTIONS_BY_HEIGHTS {
    struct request {
        void serialize(ISerializer &s) { KV_MEMBER(heights) KV_MEMBER(includeMinerTxs)
                                                 KV_MEMBER(range) }
    ...
    struct response {
        void serialize(ISerializer &s) { KV_MEMBER(transactions) KV_MEMBER(missedTxs)
                                                 KV_MEMBER(status) }
...
struct COMMAND_RPC_GET_RAW_TRANSACTIONS_FROM_POOL {
    ...
    struct response {
        void serialize(ISerializer &s) { KV_MEMBER(transactions) KV_MEMBER(status) }
...
struct COMMAND_RPC_GET_TX_GLOBAL_OUTPUTS_INDEXES {
    ...
    struct response {
        void serialize(ISerializer &s) { KV_MEMBER(o_indexes) KV_MEMBER(status) }
...
struct COMMAND_RPC_GET_RANDOM_OUTPUTS_FOR_AMOUNTS_request {
    void serialize(ISerializer &s) { KV_MEMBER(amounts) KV_MEMBER(outs_count) }
...
struct COMMAND_RPC_GET_RANDOM_OUTPUTS_FOR_AMOUNTS_response {
    void serialize(ISerializer &s) { KV_MEMBER(outs) KV_MEMBER(status) }
...
struct COMMAND_RPC_START_MINING {
    struct request {
        void serialize(ISerializer &s) { KV_MEMBER(miner_address) KV_MEMBER(threads_count) }
...
struct COMMAND_RPC_GET_INFO {
    ...
    struct response {
        void serialize(ISerializer &s) {
            KV_MEMBER(status) KV_MEMBER(version) KV_MEMBER(height) KV_MEMBER(
                    top_block_hash) KV_MEMBER(difficulty) KV_MEMBER(min_tx_fee)
                    KV_MEMBER(readable_tx_fee) KV_MEMBER(tx_count) KV_MEMBER(
                            tx_pool_size) KV_MEMBER(alt_blocks_count)
                            KV_MEMBER(outgoing_connections_count) KV_MEMBER(
                                    incoming_connections_count) KV_MEMBER(rpc_connections_count)
                                    KV_MEMBER(white_peerlist_size) KV_MEMBER(
                                            grey_peerlist_size) KV_MEMBER(last_known_block_index)
                                            KV_MEMBER(start_time) KV_MEMBER(fee_address) KV_MEMBER(
                                                    block_major_version)
                                                    KV_MEMBER(already_generated_coins) KV_MEMBER(
                                                            contact) KV_MEMBER(block_minor_version)
                                                            KV_MEMBER(last_block_reward) KV_MEMBER(
...
struct COMMAND_RPC_GET_VERSION {
    ...
    struct response {
        void serialize(ISerializer &s) { KV_MEMBER(version) }
...
struct COMMAND_RPC_GET_HARDWARE_INFO {
    ...
    struct CPUEntry {
        void serialize(ISerializer &s) { KV_MEMBER(coreCount) KV_MEMBER(threadCount)
    ...
    struct RAMEntry {
        void serialize(ISerializer &s) {
            KV_MEMBER(ramTotal) KV_MEMBER(ramUsedTotal) KV_MEMBER(ramAvailable)
                    KV_MEMBER(ramUsageVirt) KV_MEMBER(ramUsagePhys) KV_MEMBER(ramUsageVirtMax)
    ...
    struct SpaceEntry {
        void serialize(ISerializer &s) { KV_MEMBER(freeSpace) KV_MEMBER(availableSpace)
    ...
    struct response {
        void serialize(ISerializer &s) { KV_MEMBER(status) KV_MEMBER(uptime) KV_MEMBER(cpuInfo)
                                                 KV_MEMBER(ramInfo) KV_MEMBER(spaceInfo) }
...
struct COMMAND_RPC_GET_PEER_LIST {
    ...
    struct response {
        void serialize(ISerializer &s) { KV_MEMBER(peers) KV_MEMBER(status) }
...
struct COMMAND_RPC_GET_FEE_ADDRESS {
    ...
    struct response {
        void serialize(ISerializer &s) { KV_MEMBER(fee_address) KV_MEMBER(status) }
...
struct COMMAND_RPC_GET_BLOCK_COUNT {
    ...
    struct response {
        void serialize(ISerializer &s) { KV_MEMBER(count) KV_MEMBER(status) }
...
struct COMMAND_RPC_GET_BLOCK_TEMPLATE {
    struct request {
        void serialize(ISerializer &s) { KV_MEMBER(reserve_size) KV_MEMBER(wallet_address) }
    ...
    struct response {
        void serialize(ISerializer &s) {
            KV_MEMBER(difficulty) KV_MEMBER(height) KV_MEMBER(reserved_offset)
                    KV_MEMBER(blocktemplate_blob) KV_MEMBER(blockhashing_blob) KV_MEMBER(status)
        }
...
struct BLOCK_HEADER_RESPONSE_ENTRY {
    void serialize(ISerializer &s) {
        KV_MEMBER(major_version) KV_MEMBER(minor_version) KV_MEMBER(timestamp) KV_MEMBER(prev_hash)
                KV_MEMBER(nonce) KV_MEMBER(orphan_status) KV_MEMBER(height) KV_MEMBER(depth)
                        KV_MEMBER(hash) KV_MEMBER(difficulty) KV_MEMBER(reward)
    }
...
struct BLOCK_HEADER_RESPONSE {
    void serialize(ISerializer &s) { KV_MEMBER(block_header) KV_MEMBER(status) }
...
struct TRANSACTION_SHORT_RESPONSE {
    void serialize(ISerializer &s) { KV_MEMBER(hash) KV_MEMBER(fee) KV_MEMBER(amount_out)
                                             KV_MEMBER(size) }
...
struct TRANSACTION_DETAILS_EXTRA_RESPONSE {
    void serialize(ISerializer &s) { KV_MEMBER(padding) KV_MEMBER(publicKey) KV_MEMBER(nonce)
                                             KV_MEMBER(raw) }
...
struct TRANSACTION_DETAILS_RESPONSE {
    void serialize(ISerializer &s) { KV_MEMBER(hash) KV_MEMBER(size) KV_MEMBER(paymentId)
                                             KV_MEMBER(mixin) KV_MEMBER(fee) KV_MEMBER(amount_out)
                                                     KV_MEMBER(confirmations) KV_MEMBER(extra) }
...
struct MEMPOOL_TRANSACTION_RESPONSE {
    void serialize(ISerializer &s) {
        KV_MEMBER(hash) KV_MEMBER(fee) KV_MEMBER(amount_out) KV_MEMBER(size) KV_MEMBER(receiveTime)
                KV_MEMBER(keptByBlock) KV_MEMBER(max_used_block_height) KV_MEMBER(max_used_block_id)
                        KV_MEMBER(last_failed_height) KV_MEMBER(last_failed_id) KV_MEMBER(tx_json)
    }
...
struct BLOCK_SHORT_RESPONSE {
    void serialize(ISerializer &s) { KV_MEMBER(timestamp) KV_MEMBER(height) KV_MEMBER(hash)
                                             KV_MEMBER(cumul_size) KV_MEMBER(tx_count)
                                                     KV_MEMBER(reward) KV_MEMBER(difficulty)
...
struct BLOCK_DETAILS_RESPONSE {
    void serialize(ISerializer &s) {
        KV_MEMBER(major_version) KV_MEMBER(minor_version) KV_MEMBER(timestamp) KV_MEMBER(prev_hash)
                KV_MEMBER(nonce) KV_MEMBER(orphan_status) KV_MEMBER(height) KV_MEMBER(
                        depth) KV_MEMBER(hash) KV_MEMBER(difficulty) KV_MEMBER(cumulativeDifficulty)
                        KV_MEMBER(reward) KV_MEMBER(blockSize) KV_MEMBER(sizeMedian)
                                KV_MEMBER(effectiveSizeMedian) KV_MEMBER(transactionsCumulativeSize)
                                        KV_MEMBER(alreadyGeneratedCoins)
                                                KV_MEMBER(alreadyGeneratedTransactions)
                                                        KV_MEMBER(baseReward) KV_MEMBER(penalty)
...
struct COMMAND_RPC_GET_BLOCKS_LIST {
    ...
    struct response {
        void serialize(ISerializer &s) { KV_MEMBER(blocks) KV_MEMBER(status) }
...
struct COMMAND_RPC_GET_BLOCK_DETAILS {
    ...
    struct response {
        void serialize(ISerializer &s) { KV_MEMBER(block) KV_MEMBER(status) }
...
struct COMMAND_RPC_GET_TRANSACTION_DETAILS {
    ...
    struct response {
        void serialize(ISerializer &s) { KV_MEMBER(tx) KV_MEMBER(txDetails) KV_MEMBER(block)
                                                 KV_MEMBER(status) }
...
struct COMMAND_RPC_QUERY_BLOCKS {
    ...
    struct response {
        void serialize(ISerializer &s) { KV_MEMBER(status) KV_MEMBER(start_height)
                                                 KV_MEMBER(current_height) KV_MEMBER(full_offset)
                                                         KV_MEMBER(items) }
...
struct COMMAND_RPC_QUERY_BLOCKS_LITE {
    ...
    struct response {
        void serialize(ISerializer &s) { KV_MEMBER(status) KV_MEMBER(startHeight)
                                                 KV_MEMBER(currentHeight) KV_MEMBER(fullOffset)
                                                         KV_MEMBER(items) }
...
struct COMMAND_RPC_QUERY_BLOCKS_DETAILED {
    struct request {
        void serialize(ISerializer &s) { KV_MEMBER(blockIds) KV_MEMBER(timestamp) }
...
struct COMMAND_RPC_CHECK_TX_KEY {
    struct request {
        void serialize(ISerializer &s) { KV_MEMBER(txid) KV_MEMBER(txkey) KV_MEMBER(address) }
    ...
    struct response {
        void serialize(ISerializer &s) { KV_MEMBER(amount) KV_MEMBER(outputs) KV_MEMBER(status) }
...
struct COMMAND_RPC_CHECK_TX_WITH_PRIVATE_VIEW_KEY {
    struct request {
        void serialize(ISerializer &s) { KV_MEMBER(txid) KV_MEMBER(view_key) KV_MEMBER(address) }
    ...
    struct response {
        void serialize(ISerializer &s) { KV_MEMBER(amount) KV_MEMBER(outputs)
                                                 KV_MEMBER(confirmations) KV_MEMBER(status) }
...
struct COMMAND_RPC_VERIFY_MESSAGE {
    struct request {
        void serialize(ISerializer &s) { KV_MEMBER(message) KV_MEMBER(address)
                                                 KV_MEMBER(signature) }
...
struct COMMAND_RPC_GET_BLOCKS_DETAILS_BY_HEIGHTS {
    ...
    struct response {
        void serialize(ISerializer &s) { KV_MEMBER(status) KV_MEMBER(blocks) }
...
struct COMMAND_RPC_GET_BLOCK_DETAILS_BY_HEIGHT {
    ...
    struct response {
        void serialize(ISerializer &s) { KV_MEMBER(status) KV_MEMBER(block) }
...
struct COMMAND_RPC_GET_BLOCKS_HASHES_BY_TIMESTAMPS {
    struct request {
        void serialize(ISerializer &s) { KV_MEMBER(timestampBegin) KV_MEMBER(timestampEnd)
                                                 KV_MEMBER(limit) }
    ...
    struct response {
        void serialize(ISerializer &s) { KV_MEMBER(status) KV_MEMBER(count) KV_MEMBER(blockHashes) }
...
struct COMMAND_RPC_GET_TRANSACTIONS_DETAILS_BY_HASHES {
    ...
    struct response {
        void serialize(ISerializer &s) { KV_MEMBER(status) KV_MEMBER(transactions) }
...
struct DIFFICULTY_STATISTICS {
    void serialize(ISerializer &s) { KV_MEMBER(block_num) KV_MEMBER(avg_solve_time)
                                             KV_MEMBER(stddev_solve_time) KV_MEMBER(outliers_num)
                                                     KV_MEMBER(avg_diff) KV_MEMBER(min_diff)
                                                             KV_MEMBER(max_diff) }
...
struct COMMAND_RPC_GET_DIFFICULTY_STAT {
    ...
    struct response {
        void serialize(ISerializer &s) {
            KV_MEMBER(status) KV_MEMBER(hour) KV_MEMBER(day) KV_MEMBER(week) KV_MEMBER(month)
                    KV_MEMBER(halfyear) KV_MEMBER(year) KV_MEMBER(blocks30) KV_MEMBER(blocks720)
                            KV_MEMBER(blocks5040) KV_MEMBER(blocks21900) KV_MEMBER(blocks131400)
...
struct RESERVE_PROOF_ENTRY {
    void serialize(ISerializer &s) { KV_MEMBER(txid) KV_MEMBER(index_in_tx) KV_MEMBER(shared_secret)
                                             KV_MEMBER(key_image) KV_MEMBER(shared_secret_sig)
...
struct RESERVE_PROOF {
    void serialize(ISerializer &s) { KV_MEMBER(proofs) KV_MEMBER(signature) }
