...
public:
    ...
    virtual void notify(Tools::QObserverManager<QwertyNote::IWalletLegacyObserver> &observer) = 0;
};
...
public:
    ...
    void notify(Tools::QObserverManager<QwertyNote::IWalletLegacyObserver> &observer) override
    {
