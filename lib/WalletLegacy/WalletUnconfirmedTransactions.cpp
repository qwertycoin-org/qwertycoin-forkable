...
WalletUnconfirmedTransactions::WalletUnconfirmedTransactions(uint64_t uncofirmedTransactionLiveTime)
    : m_uncofirmedTransactionsLiveTime(uncofirmedTransactionLiveTime)
{
}
...
void WalletUnconfirmedTransactions::deleteUsedOutputs(
    const std::vector<TransactionOutputId> &outputs)
{
